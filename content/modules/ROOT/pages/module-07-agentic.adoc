...
image:llama/maas_endpoint.png[]

7. Click save

image:llama/save_yaml.png[]

== View Your Deployment

1. Select the `Developer` perspective.

image:llama/dev_perspective.png[]

2. Search for the `lls-demo` namespace

image:llama/find-namespace.png[]
...
image:llama/playground_link.png[]
