...
* **Pipelines**: We won't use Pipelines in this workshop, but you can use them to automate the process of training and deploying machine learning models.
...
If you click on the expand button at the lft of the model, you will see more information about its configura, such as the resources allocated to it.
...
In both cases, the answer should take some more time than previously as we are running on a CPU (and you may need to try a few times to get something meaningful), and look like this:
