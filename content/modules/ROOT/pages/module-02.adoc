...
+
[.bordershadow]
image::02/02-create-workbench-full.png[]
...
_When pasting content for the first time, your workbench may prompt you to grant paste access. Please allow it to enable copy-paste functionality._
...
* Please get back to the OpenShift AI Dashboard.
