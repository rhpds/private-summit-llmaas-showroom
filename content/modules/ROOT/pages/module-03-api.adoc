...
NOTE: Save these values separately for the next step.
...
NOTE: Copy and save this information separately - you will use it in the next module to make real requests to your model.
